...
kubectl kubectl set image  deployment/pod-status-monitor pod-status-monitor=registry.intra.weibo.com/weibo_rd_algorithmplatform/pod-monitor:dev-${GIT_HEAD} -n argo